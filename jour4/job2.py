...
marine = Eleve()
print(marine.bonjour())
marine.modifier_age(16)
print(marine.afficher_age())
print(marine.aller_en_cours())

gustave = Professeur("SES")
gustave.modifier_age(40)
print(gustave.bonjour())
print(gustave.enseigner())
